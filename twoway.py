...
def find_leaf(a, b):
    ...
    while True:
        ...
        gen_straight_way(straight_seen, straight_leafs, new_leafs_straight, straight_tree)
        gen_back_way(reverse_seen, reverse_leafs, new_leafs_reverse)
...
def gen_straight_way(seen, leafs, new_leafs, tree):
    new_leafs = []
    for i in leafs:
        cur_value = i.value * 2
...
def gen_back_way(seen, leafs, new_leafs):
    for i in leafs:
        val = i.value
        if val % 2 == 0:
            cur_value = val // 2
